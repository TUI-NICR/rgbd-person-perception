...
1. [Download](https://drive.google.com/u/0/uc?id=1d9dA9hDso1HV4Eljpc1XtC_9LEjZaTaK) and extract pretrained models to `./trained_models`.
2. [Download](https://drive.google.com/u/0/uc?id=1WTjZJ4Ju1u0NRJ0osPeLrs6lt2hJ8v-o) and extract example patches to `./samples`.
